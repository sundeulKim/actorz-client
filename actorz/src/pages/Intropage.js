    ...
    <>
      {isPc &&
            ...
            <Slider {...settings} className="freeGroup" >
              ...
              <div className="free2">
                <div className="setOrder">
                  ...
                  <div className="set5">
                    <img className="setPhotoA" alt="" src="https://media.vlpt.us/images/iooi75/post/3c22e9a1-6c10-44fa-b8e2-ecdec3ed2ccd/thumb-2009107696_xPJE0lpT_da11888d84e969f6f85acbdb214582d75c19fd86_370x420.jpg"/>
                  </div>
                </div>
        ...
        <div className="profilesEffectTest">
          <Comment.Group className="profilePos" style={{transform: `translateX(${-position+7600}px)`}} size='massive'>
              <Comment>
          ...
          <Comment.Group style={{transform: `translateX(${-position+8350}px)`}} size='small'>
            <Comment>
          ...
          <Comment.Group className="profilePos" style={{transform: `translateX(${-position+8800}px)`}} size='massive'>
            <Comment>
          ...
          <Comment.Group className="profilePos" style={{transform: `translateX(${-position+9600}px)`}} size='massive'>
            <Comment>
          ...
          <Comment.Group style={{transform: `translateX(${-position+7770}px)`}} size='massive'>
            <Comment>
          ...
          <Comment.Group className="profilePos" style={{transform: `translateX(${-position+9400}px)`}} size='large'>
            <Comment>
          ...
          <Comment.Group style={{transform: `translateX(${-position+7590}px)`}} size='large'>
            <Comment>
          ...
          <Comment.Group className="profilePos" style={{transform: `translateX(${-position+7900}px)`}} size='massive'>
            <Comment>
          ...
          <Comment.Group style={{transform: `translateX(${-position+9050}px)`}} size='massive'>
            <Comment>
          ...
          <Comment.Group style={{transform: `translateX(${-position+9650}px)`}} size='large'>
            <Comment>
          ...
          <Comment.Group className="profilePos" style={{transform: `translateX(${-position+9900}px)`}} size='large'>
            <Comment>
          ...
          <Comment.Group style={{transform: `translateX(${-position+8900}px)`}} size='massive'>
            <Comment>
          ...
          <Comment.Group style={{transform: `translateX(${-position+9300}px)`}} size='massive'>
            <Comment>
          ...
          <Comment.Group style={{transform: `translateX(${-position+9900}px)`}} size='massive'>
            <Comment>
          ...
          <Comment.Group className="rePositioning" style={{transform: `translateX(${-position+9000}px)`}} size='massive'>
            <Comment>
      ...
      {isTablet &&
                ...
                <div className="setOrder">
                  ...
                  <div className="colorTest02"> ACTORZ </div>
                    ...
                    <div className="colorTest01"> 매번 똑같은 포트폴리오 양식 <br/><br/><br/> 나만의 특별한 포트폴리오에 사진과 영상을 담아 남들과 다른 포트폴리오를 만들어 드리겠습니다 </div>
                      ...
                      <div className="btnPosTop">
                        <Link to="/mainpage">
                          <button className="startButton1T">시작하기</button>
                        </Link>
                      </div>
                      <br />
                      <br />
        ...
        <div className="mobileCommentsCenterPosition">
          ...
          <div className="mobileCommentsPosition">
            ...
            <Comment.Group data-trigger className="commentsBlurEffect" size='large'>
              <Comment>
                <Comment.Avatar className="commentsBlurEffect" as='a' src='https://media.vlpt.us/images/iooi75/post/a0e76905-5ec8-4bcc-8d64-2db0a6e6e168/image.png' />
            ...
            <Comment.Group className="commentsBlurEffect2" data-trigger size='large'>
              <Comment>
                <Comment.Avatar className="commentsBlurEffect2" as='a' src='https://media.vlpt.us/images/iooi75/post/3c22e9a1-6c10-44fa-b8e2-ecdec3ed2ccd/thumb-2009107696_xPJE0lpT_da11888d84e969f6f85acbdb214582d75c19fd86_370x420.jpg' />
            ...
            <Comment.Group className="commentsBlurEffect3" data-trigger size='large'>
              <Comment>
                <Comment.Avatar className="commentsBlurEffect3" as='a' src='https://media.vlpt.us/images/iooi75/post/a061751c-9e73-4344-9ff4-8edd9fc70dfa/image.png' />
            ...
            <Comment.Group className="commentsBlurEffect4" data-trigger size='massive'>
              <Comment>
                <Comment.Avatar className="commentsBlurEffect4" as='a' src='https://media.vlpt.us/images/iooi75/post/9763ba86-5501-426f-ada9-a43206c5e68d/image.png' />
            ...
            <Comment.Group className="commentsBlurEffect5" data-trigger size='large'>
              <Comment>
                <Comment.Avatar className="commentsBlurEffect5" as='a' src='https://media.vlpt.us/images/iooi75/post/d820e8e1-9b0e-467e-9ae3-cbf9f41facc2/image.png' />
            ...
            <Comment.Group data-trigger className="commentsBlurEffect6" size='large'>
              <Comment>
                <Comment.Avatar className="commentsBlurEffect6" as='a' src='https://media.vlpt.us/images/iooi75/post/68b1c9d4-5bca-4b69-bf4f-b0f7f9063b69/image.png' />
            ...
            <Comment.Group data-trigger className="commentsBlurEffect7" size='large'>
              <Comment>
                <Comment.Avatar className="commentsBlurEffect7" as='a' src='https://media.vlpt.us/images/iooi75/post/8b5bce11-546a-40fe-bfc0-cf0ff345029d/image.png' />
            ...
            <Comment.Group data-trigger className="commentsBlurEffect8" size='massive'>
              <Comment>
                <Comment.Avatar className="commentsBlurEffect8" as='a' src='https://media.vlpt.us/images/iooi75/post/9dd6bae5-a8f7-491a-9dca-6abdb5d6658d/image.png' />
            ...
            <Comment.Group data-trigger className="commentsBlurEffect9" size='massive'>
              <Comment>
                <Comment.Avatar className="commentsBlurEffect9" as='a' src='https://media.vlpt.us/images/iooi75/post/c59e08f7-2ec0-496a-b276-1252bf46e6e6/image.png' />
            ...
            <Comment.Group data-trigger className="commentsBlurEffect10" size='massive'>
              <Comment>
                <Comment.Avatar className="commentsBlurEffect10" as='a' src='https://media.vlpt.us/images/iooi75/post/5533a9b7-f895-402b-8ca8-fb9b69f5a3b9/image.png' />
            ...
            <Comment.Group data-trigger className="commentsBlurEffect11" size='massive'>
              <Comment>
                <Comment.Avatar className="commentsBlurEffect11" as='a' src='https://media.vlpt.us/images/iooi75/post/ecaed6e9-6e2a-4027-87dd-ab705e9ffec0/image.png' />
        ...
        */}
          ...
          <div className="device2T">
            <div data-trigger>
              <img alt="" className="ipadPicT" src="https://media.vlpt.us/images/iooi75/post/11d9594f-fd05-4245-a804-9c78addaab02/image.png" />
      ...
      {isMobile && <>
        ...
        <div className="blockPosition"></div>
          <div data-trigger className="startContentsTitleM" >
            <div>
              포트폴리오에 <br/> <br/> <br/> 사진과 영상을 담을 수 있다면 어떨까?
            </div>
            <br/>
            <br/>
            <br/>
          ...
          <div className="gifPositioning">
            <div className="gifContentsM" data-trigger>
              <img className="gifM" src="https://media.vlpt.us/images/iooi75/post/61f023dd-ca12-46f7-843b-70b108ca17f1/Jul-16-2021%2022-02-30.gif" alt="" />
            </div>
          </div>
        ...
        <div data-trigger className="introLastContents">
          <div className="lastContentsTitleM">
            <div className="lastContext">
              다음 2022년 시상식의 <br/><br/><br/> 주인공은 바로 여러분입니다!  <br />  <br /><br />  <br /> <br />Actorz에서 여러분의 미래를 시작하세요.
            </div>
            <br/>
            <div className="button2PositionResponsive">
              <Link to="/mainpage">
